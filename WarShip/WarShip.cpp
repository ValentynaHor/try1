...
struct MyShipMap {
    ...
    0020000020
    */
    MyShipMap() : myarena(nullptr), ShipSize(nullptr), ShipNum(nullptr), oponentarena(nullptr) {}
...
struct MyShips
{
    MyShips() : orientation(nullptr), damage(nullptr), dead(nullptr), posKols(nullptr), posRows(nullptr) {}
    //розмір корабля
    int size = 0;
            ...
            case ButtonStart:
            {
                ...
                if (rPole1 != nullptr) {
                    for (int i = 0; i < prevnumKol; i++) {
                        ...
                        if (rPole2 && rPole2[i]) { delete[] rPole2[i]; rPole2[i] = nullptr; }
                    ...
                    delete[] rPole1; rPole1 = nullptr;
                    delete[] rPole2; rPole2 = nullptr;
